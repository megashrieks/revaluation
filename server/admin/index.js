...
router.post('/add_students_ex', check_token, excel_upload_middleware, functions.add_students_ex);

router.post('/add_subject', check_token, functions.add_subject);

router.post('/add_subjects_ex', check_token, excel_upload_middleware, functions.add_subjects_ex);
